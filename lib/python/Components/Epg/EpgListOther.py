...
from EpgListBase import EPGListBase, EPG_TYPE_SINGLE, EPG_TYPE_SIMILAR, EPG_TYPE_ENHANCED, EPG_TYPE_INFOBAR
...
class EPGListOther(EPGListBase):
	...
	def setItemsPerPage(self):
		if self.type == EPG_TYPE_ENHANCED or self.type == EPG_TYPE_SINGLE or self.type == EPG_TYPE_SIMILAR:
